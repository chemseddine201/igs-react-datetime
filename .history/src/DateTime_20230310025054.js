		...
		let viewProps = {
			...
			isValidDate: () => {
				...
				if (props.isValidDate instanceof Function) {
					return props.isValidDate(this.getSelectedDate());
				} else if (state.minDate && state.maxDate) {
					return (this.getSelectedDate()).isBetween(state.minDate, state.maxDate);
				} else if (state.minDate) {
					return (this.getSelectedDate()).isAfter(state.minDate);
				} else if (state.maxDate) {
					return (this.getSelectedDate()).isBefore(state.maxDate);
				}
				return true;
			},
