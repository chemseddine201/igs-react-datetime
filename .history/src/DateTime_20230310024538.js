		...
		let viewProps = {
			...
			isValidDate: () => {
				if (props.isValidDate) {
					...
					return (this.getSelectedDate())?.isBetween(this.minDate, this.maxDate);
				} elseif (this.minDate) {
					return this.getSelectedDate().isAfter(this.minDate);
				} elseif (this.maxDate) {
					return this.getSelectedDate().isBefore(this.maxDate);
				}
			},
