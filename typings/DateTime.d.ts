...
declare namespace ReactDatetimeClass {
    ...
    export interface DatetimepickerProps {
        ...
        */
        ...
        /*
        Used to specify the minimum date allowed on the calendar
         */
        minDate?: Date | string | Moment;
        /*
        Used to specify the maximum date allowed on the calendar
        */
        maxDate?: Date | string | Moment;
        /*
        Used to specify the navigation icon also possible to use text
        */
